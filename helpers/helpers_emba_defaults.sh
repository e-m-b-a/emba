...
set_defaults() {
  ...
  export GHIDRA_DECOMPILE_RUNTIME="120m"
...
set_log_paths() {
  ...
  export L10_LOG="${LOG_DIR}/l10_system_emulation.txt"
  export L10_CSV_LOG="${CSV_DIR}/l10_system_emulation.csv"
